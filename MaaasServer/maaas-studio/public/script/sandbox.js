...
{
    // !!! Not sure if this needs to be configurable.  The maaas-api processor has a virtual path (where it pretends all 
    //     modules are loaded from), so any debugger interaction with maaas modules (like breakpoints) need to use that
    //     path prefix to the module name.
    //
    return "maaas-api\\lib\\routes\\";
}
