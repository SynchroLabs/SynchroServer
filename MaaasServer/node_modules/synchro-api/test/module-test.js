...
describe("Synchro API module", function () 
{
	...
	describe("Processor Manager", function() 
	{
		...
		{
			assert.equal(apiProcessorManager.getAppModuleStore("inproc"), inprocProcessor.appModuleStore); 
			assert.equal(apiProcessorManager.getAppModuleStore("forked"), forkedProcessor.appModuleStore); 
		});
