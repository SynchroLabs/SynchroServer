...
SynchroStudio.prototype.addRoutes = function(expressApp, config, checkAuthFn)
{
	...
	expressApp.get('/', checkAuth, function(request, response) 
	{
	    ...
	    wait.launchFiber(function()
	    {
	        ...
	        {
	            var appModuleStore = self.apiManager.getAppModuleStore(appPath);
...
SynchroStudio.prototype.getAppModuleStore = function(appName)
{
	return this.apiManager.getAppModuleStore(appName);
}
