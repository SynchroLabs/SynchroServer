...
module.exports = function(params)
{
    ...
    function listBlobs(containerName, callback)
    {
    ...
    function getBlobText(containerName, blobName, callback)
    {
    ...
    function setBlobText(containerName, blobName, text, callback)
    {
    ...
    function removeBlob(containerName, blobName, callback)
    {
    ...
    var moduleStore = 
    {
        ...
        getAppModuleStore: function(container)
        {
            var app =
            {
                ...
                {
                    var content = wait.for(getBlobText, container, "synchro.json");
                ...
                listModules: function()
                {
                    ...
                    var blobs = wait.for(listBlobs, container);
                ...
                {
                    var content = wait.for(getBlobText, container, moduleFilename);
                    return stripBom(content);
                },

                putModuleSource: function(moduleFilename, content)
                {
                    return wait.for(setBlobText, container, moduleFilename, content);
                },

                removeModuleSource: function(moduleFilename)
                {
                    return wait.for(removeBlob, container, moduleFilename, content);
                }
            }
