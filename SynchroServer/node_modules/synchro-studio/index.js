...
SynchroStudio.prototype.addRoutes = function(expressApp, config, checkAuthFn)
{
	...
	{
	    co(edit.createApp, self, req.params.appName, req, res).catch(function(err)
        {
            logger.error("Error in edit.createApp:", err);
        });
	});

	expressApp['get'](this.basePath + '/:appName', checkAuth, function(req,res)
	{
	    co(edit.getApp, self, req.params.appName, req, res).catch(function(err)
        {
            logger.error("Error in edit.getApp:", err);
        });
	});
