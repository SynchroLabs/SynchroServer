...
SynchroStudio.prototype.addRoutes = function(expressApp, config, checkAuthFn)
{
	...
	expressApp.get('/', checkAuth, function(request, response) 
	{
	    ...
	    wait.launchFiber(function()
	    {
	        ...
	        {
	            var appModuleStore = self.apiManager.getAppModuleStoreForPath(appPath);
...
SynchroStudio.prototype.getAppModuleStoreForPath = function(appName)
{
	return this.apiManager.getAppModuleStoreForPath(appName);
}
