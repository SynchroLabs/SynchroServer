...
// Constructor
//
var SynchroStudio = function(config, basePath, apiManager)
{
	this.config = config;
...
SynchroStudio.prototype.addRoutes = function(expressApp, config, checkAuthFn)
{
	...
	expressApp.get('/', checkAuth, function(request, response) 
	{
	    ...
	    co(function * ()
	    {
	        ...
	        {
	            var appModuleStore = yield self.apiManager.getAppModuleStoreForPath(appPath);
	            ...
	            { 
	                ...
	                appDefinition: appModuleStore.getAppDefinition()
	            });
	        }
...
SynchroStudio.prototype.getAppModuleStoreForPath = function * (appName) // Generator
{
	return yield this.apiManager.getAppModuleStoreForPath(appName);
}
