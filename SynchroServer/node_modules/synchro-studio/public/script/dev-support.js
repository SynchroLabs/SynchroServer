...
function populatePropertyInspectorWidgets(divId, widgets)
{
...
function onSelectionChange()
{
    ...
    if (selectedControl != controlNode)
    {
        ...
        if (controlNode)
        {
            ...
            var commonWidgets = controlMeta["*"].attributes;
            var controlWidgets = controlMeta[controlType] && controlMeta[controlType].attributes;

            $('#control-type').text(controlMeta[controlType].name);
            populatePropertyInspectorWidgets('control-widget-container', controlWidgets);
            populatePropertyInspectorWidgets('common-widget-container', commonWidgets);
