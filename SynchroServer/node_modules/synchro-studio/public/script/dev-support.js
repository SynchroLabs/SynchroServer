    ...
    try
    {
        ...
        if (parsed.type === 'Program')
        {
            for (var i = 0; i < parsed.body.length; i++)
            {
                ...
                {
                    initViewModelFnRange = rangeFromLocation(exp.expression.right.loc);
        ...
        if (view)
        {
            ...
            else if (initViewModelFnRange) // fall back to var viewModel = {} from exports.InitializeViewModel
            {
                try
                {
                    ...
                    eval(
                        "var initializeViewModel = " + editor.getSession().getTextRange(initViewModelFnRange) + '\n' +
            ...
            console.log("ViewModel:", JSON.stringify(viewModel, null, 4));
