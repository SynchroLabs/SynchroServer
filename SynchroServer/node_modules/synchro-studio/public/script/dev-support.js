...
function showUXDropTarget(target)
{
    ...
    if (synchroControl)
    {
        ...
        else
        {
            ...
            // !!! Still some work to do in terms of adjusting placeholder position so that it properly borders the target element.
            //
            ...
            if (target.orientation === 'Horizontal')
            {
                ...
                {
                    placeholder.style.top = pos.top + 'px'; 
                    placeholder.style.left = pos.left + $(synchroControl).outerWidth() + 'px';
                }
            }
            else // Vertical
            {
                ...
                {
                    placeholder.style.top = pos.top + $(synchroControl).outerHeight() + 'px';
                    placeholder.style.left = pos.left + 'px';
                }
            }
