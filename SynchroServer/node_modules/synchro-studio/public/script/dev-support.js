...
function getUXDropTarget(clientX, clientY)
{
    ...
    if (synchroControl)
    {
        // Get "View" control node from UX control
        //
        ...
        if (viewNode)
        {
            ...
            {
                node: viewNode,
                position: "before", // !!! Until we get our position logic working, we'll just say "before" (this will allow test)
                attribute: null
            }
...
function showUXDropTarget(target)
{
    ...
    var synchroControl = selectVisualElementFromIndexes($("#synchro_container"), target.node.indexes);
    if (synchroControl)
    {
