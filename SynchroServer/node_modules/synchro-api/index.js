...
exports.createApiProcessorManager = function(baseDebugPort, config)
{
    ...
    var apiManager =
    {
        ...
        getAppModuleStore: function * (appPath, appContainer, moduleStoreSpec) // Generator
        {
            ...
            if (!moduleStores[appPath])
            {
                ...
                moduleStores[appPath] = yield moduleStore.getAppModuleStore(appContainer);
            }

            return moduleStores[appPath];
        },

        getAppModuleStoreForPath: function * (appPath) // Generator
        {
            ...
            if (!moduleStores[appPath])
            {
                ...
                if (apiProcessor)
                {
                    yield this.getAppModuleStore(appPath, apiProcessor.appContainer, apiProcessor.moduleStoreSpec);
                }
                else
                {
