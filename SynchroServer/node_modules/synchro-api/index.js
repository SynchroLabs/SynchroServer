...
exports.createSessionStore = function(config)
{
    ...
    return exports.createServiceFromSpec(sessionStoreSpec);
}

exports.createModuleStore = function(config)
{
    var moduleStoreSpec =
    {
    ...
    return exports.createServiceFromSpec(moduleStoreSpec);
}
...
exports.createApiProcessorManager = function(baseDebugPort, config)
{
    ...
    var apiManager =
    {
        ...
        {
            return exports.createModuleStore(config);
        },
        ...
        getAppModuleStoreAwaitable: function * (appPath, appContainer) // Generator
        {
            ...
            {
                var moduleStore = this.createModuleStore();
