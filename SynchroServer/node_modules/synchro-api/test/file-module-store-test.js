...
describe("File module store", function()
{
    it("should list containers", function(done) 
    {
    	co(function * ()
    	{
	    	...
	    	var containers = yield moduleStore.getAppContainers();
    ...
    it("should create container", function(done) 
    {
    	co(function * ()
    	{
	    	...
	    	yield moduleStore.createAppContainer("foo");
    ...
    it("should delete container", function(done) 
    {
        ...
        co(function * ()
        {
            yield moduleStore.deleteAppContainer("foo");
        });
    ...
    it("should fail to create container that already exists", function(done) 
    {
    	co(function * ()
    	{
	    	...
	    	try
	    	{
		    	yield moduleStore.createAppContainer("testapp");
	    	}
	    	catch (err)
	    	{
		    	done();
    ...
    it("should fail to delete container that doesn't contain app", function(done) 
    {
    	co(function * ()
    	{
	    	...
	    	try
	    	{
		    	yield moduleStore.deleteAppContainer("testconfig");
	    	}
	    	catch (err)
	    	{
		    	done();
    ...
    it("should get app module store from valid container", function(done) 
    {
    	co(function * ()
    	{
	    	...
	    	var appModuleStore = yield moduleStore.getAppModuleStore("testapp");

	    	var app = yield appModuleStore.getAppDefinition();
    ...
    it("should fail to get app module store from invalid valid container", function(done) 
    {
    	co(function * ()
    	{
	    	...
	    	try
	    	{
		    	yield moduleStore.getAppModuleStore("foo");
	    	}
	    	catch (err)
	    	{
		    	done();
