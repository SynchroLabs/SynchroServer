...
describe("File module store", function()
{
    ...
    {
    	var moduleStore = yield FileModuleStore.createServiceAwaitable({ directory: __dirname });
    ...
    it("should delete container", function(done) 
    {
        ...
        co(function * ()
        {
            moduleStore = yield FileModuleStore.createServiceAwaitable({ directory: __dirname });
