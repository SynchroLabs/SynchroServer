	...
	describe("Processor Manager", function() 
	{
		...
		var services = 
		{
		    ...
		    moduleStoreSpec:
			{
				...
				serviceConfiguration: { directory: __dirname }
			},
		...
		{
			apiProcessorManager.createApiProcessorAsync("inproc", "testapp", services, false, false, function(err, apiProcessor)
			{
		...
		{
			apiProcessorManager.createApiProcessorAsync("forked", "testapp", services, true, true, function(err, apiProcessor)
			{
		...
		{
            var inprocModuleStore = apiProcessorManager.getAppModuleStore("inproc2", "testapp", services.moduleStoreSpec);
            var forkedModuleStore = apiProcessorManager.getAppModuleStore("forked2", "testapp", services.moduleStoreSpec);
