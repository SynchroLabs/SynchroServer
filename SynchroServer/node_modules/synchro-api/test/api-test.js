...
describe("API Processor", function()
{
	...
	describe("Resync", function()
	{
		...
		it("should provide view and view model on resync when no instance id provided", function(done)
		{
			requestObject = 
			{ 
				Mode: "Resync", 
    ...
    describe("Version Errors", function()
    {
        ...
        function testVersion(serverClientVersionSpec, appClientVersionSpec, clientVersion, expectedResponse, done)
        {
            var appDefinition =
            {
                name: "Test App",
        ...
        it("should pass with no version specified or required", function (done)
        {
            testVersion(null, null, null, expectedSuccessResponse, done);
        });
        
        it("should pass with client version specified, but no client version required", function (done)
        {
            testVersion(null, null, null, expectedSuccessResponse, done);
        });
        
        it("should pass with client version specified and satisfying server version requirement", function (done)
        {
            testVersion("1.1.0", null, "1.1.0", expectedSuccessResponse, done);
        });
        
        it("should pass with client version specified and satisfying app version requirement", function (done)
        {
            testVersion(null, "1.1.0", "1.1.0", expectedSuccessResponse, done);
        });

        it("should fail with server version required and no client version specified", function (done)
        {
            var expectedResponse = 
            {
                Path: "menu",
            ...
            testVersion("1.1.0", null, null, expectedResponse, done);
        });

        it("should fail with server version required and failing client version specified", function (done)
        {
            var expectedResponse = 
            {
                Path: "menu",
            ...
            testVersion("1.1.0", null, "1.0.0", expectedResponse, done);
        });

        it("should fail with app version required and no client version specified", function (done)
        {
            var expectedResponse = 
            {
                Path: "menu",
            ...
            testVersion(null, "1.1.0", null, expectedResponse, done);
        });
        
        it("should fail with app version required and failing client version specified", function (done)
        {
            var expectedResponse = 
            {
                Path: "menu",
            ...
            testVersion(null, "1.1.0", "1.0.0", expectedResponse, done);
        });
    });
});
