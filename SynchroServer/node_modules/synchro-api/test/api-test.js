...
describe("API Processor", function()
{
	...
	describe("Partial ViewModel updates", function ()
	{
		...
		before(function * ()
		{
			var modules =
			{
				...
				countdown:
				{
					...
					{
					    yield Synchro.waitForAwaitable(context, Synchro.waitInterval, 100);
					    viewModel.count = 3;
					...
					Commands:
					{
					    countdown: function * (context, session, viewModel)
					    {
					        ...
					        {
					            yield Synchro.waitForAwaitable(context, Synchro.waitInterval, 50);
					            viewModel.count--;
        ...
        it("should record view model and session updates from before and after a call to Synchro.waitForAwaitable()", function * ()
        {
		...
		var modules =
		{
			test:
			{
				...
				Commands:
				{
				    ...
				    {
				    	yield Synchro.waitForAwaitable();
				    },
		...
		it("should fail if invalid context passed to waitFor", function * () 
		{
			...
			yield readerWriter.readAsyncAwaitable(session.id + ":1", function * (err, responseObject)
			{
				var expectedResponse = 
				{
					...
					{
						name: "UserCodeError",
						message: "UserCode error in method: Command.testWaitFor - A valid context must be the first parameter to Synchro.waitForAwaitable()"
					},
					TransactionId: 1
				}
