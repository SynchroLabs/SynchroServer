...
describe("API Processor", function()
{
	...
	describe("Partial ViewModel updates", function ()
	{
			...
			var modules =
			{
				...
				countdown:
				{
					...
					Commands:
					{
					    ...
					    countupYield: function * (context, session, viewModel)
					    {
					    	session.count = viewModel.count;
					    	viewModel.count++;
					    	session.count++;
        ...
        it("should record view model and session updates from before and after a call to Synchro.yieldAwaitable()", function * ()
        {
			var plan = new assertHelper.Plan(2);
	...
	describe("services method parameter validation", function ()
	{
		...
		var modules =
		{
			test:
			{
				...
				Commands:
				{
				    ...
				    testWaitForAwaitable: function * (context)
				    {
		...
		it("should fail if invalid context passed to waitForAwaitable", function * () 
		{
			requestObject.Command = "testWaitForAwaitable";
			yield apiProcessor.processAwaitable(session, requestObject, response);
			...
			yield readerWriter.readAsyncAwaitable(session.id + ":1", function * (err, responseObject)
			{
				var expectedResponse = 
				{
					...
					{
						name: "UserCodeError",
						message: "UserCode error in method: Command.testWaitForAwaitable - A valid context must be the first parameter to Synchro.waitForAwaitable()"
					},
					TransactionId: 1
				}
