...
exports.getConfig = function(configFile, overrides)
{
    ...
    var defaults = 
    {
        ...
        // SERVER_URL_BASE - see below
        // API_URL_BASE - see below
        // APP_RESOURCE_PREFIX can be specified to override resource location, server-wide
        'LOG4JS_CONFIG': 
        { 
    ...
    // Set these default config values here (since they rely on multiple other settings from config and can't easily be set inside of the above dict)
    //
    var defStore = conf.stores["defaults"].store;
    defStore['SERVER_URL_BASE'] = conf.get("PROTOCOL") + "://" + addNonStandardPort(conf.get('HOST'), (conf.get("PORT")));
    defStore['API_URL_BASE'] = conf.get('SERVER_URL_BASE') + conf.get('API_PATH_PREFIX');
