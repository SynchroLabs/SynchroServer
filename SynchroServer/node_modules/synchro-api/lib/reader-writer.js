...
//
ReaderWriter.prototype.readAsync = function * (channelId, onRead) // Generator
{
    logger.info("readAsync, channel:", channelId);
    if (this.pendingReads[channelId])
    {
    	yield onRead("Pending read already exists for channel ID: " + channelId);
   	}
...
//
ReaderWriter.prototype.writeAsync = function * (channelId, onWrite) // Generator
{
    logger.info("writeAsync, channel:", channelId);
    if (this.pendingWrites[channelId])
    {
    	yield onWrite("Pending write already exists for channel ID: " + channelId);
   	}
