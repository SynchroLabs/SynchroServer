...
module.exports = function(params)
{
    ...
    client.on("end", function (err) {
        logger.debug("the connection has ended - " + client.host + ":" + client.port + " - " + err);
    });
	...
	if (password)
	{
		...
		{
			logger.debug("Redis client auth - err: " + err + ", result: " + result);
		});		
	}
    ...
    function heartbeat()
    {
        logger.debug("Redis ping starting...");
        client.ping(function(err, result)
        {
            ...
            {
                logger.debug("Redis ping returned: " + result);
            }
        });
    }
	...
	function getSessionRedis(sessionId, callback)
	{
        ...
        logger.debug("Redis client connected: " + client.connected);
