...
exports.createServiceAwaitable = function * (params)
{
    ...
    function * makeRequestAwaitable(method, relPath, param)
    {
        ...
        var response = yield function(done) 
        {
            ...
            logger.debug("location: %s, relPath: %s, uri: %s", location, relPath, uri);

            var options = { method: method, uri: uri, body: body, encoding: null };
    ...
    function * getContainersAwaitable()
    {
        ...
        logger.debug("getContainersAwaitable:", containers);
    ...
    function * getBlobsAwaitable(containerName)
    {
        ...
        logger.debug("getBlobsAwaitable - Files:", files);
        ...
        getAppModuleStoreAwaitable: function * (containerName)
        {
            ...
            var app =
            {
                ...
                listModulesAwaitable: function * ()
                {
                    ...
                    logger.debug("List of module files:", files);
