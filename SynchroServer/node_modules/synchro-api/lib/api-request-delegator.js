...
function createForkedRequestProcessorAsync(appPath, config, debugPort, onCreated)
{
    ...
    var requestProcessor =
    {
        ...
        reloadModule: function(moduleName)
        {
            ...
            return wait.for(reloadModuleAsync, moduleName);
        }
    }
...
function createInProcRequestProcessorAsync(appPath, config, onCreated)
{
    var apiRequestProcessorModule = require("./api-request-processor");
    var apiRequestProcessor = apiRequestProcessorModule.createApiRequestProcessorAsync(appPath, config);
    ...
    var requestProcessor =
    {
        ...
        reloadModule: function(moduleName)
        {
            return apiRequestProcessor.reloadModule(moduleName);
        }
    }
...
module.exports = function(appPath, config, fork, debugPort, onCreated)
{
    ...
    {
        wait.launchFiber(createInProcRequestProcessorAsync, appPath, config, onCreated);
    }
}