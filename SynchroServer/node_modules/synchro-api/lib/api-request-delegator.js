...
function createForkedRequestProcessorAsync(appPath, config, debugPort, onCreated)
{
    ...
    // !!! We need to place a timeout on the pendingRequests and pendingReloads.  If the child process doesn't respond for some
    //     reason, we don't want these to back up.
    //
    var requestId = 0;
    var pendingRequests = {};
