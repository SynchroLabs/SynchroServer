...
function createForkedRequestProcessorAsync(params, debugPort, loggingConfig, onCreated)
{
    ...
    function getRequestDataObject(request)
    {
        ...
        var requestData = 
        {
            ...
            url: request.url,
            secure: request.secure || request.get('x-arr-ssl'), // For Azure, need to check x-arr-ssl, since it terminates SSL for us
...
module.exports = function(appContainer, sessionStoreSpec, moduleStoreSpec, resourceResolverSpec, appRootPath, fork, debugPort, loggingConfig, onCreated)
{ 
    var params = 
    {
