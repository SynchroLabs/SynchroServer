...
exports.createApiRequestProcessorAsync = function(params, callback)
{
    ...
    var moduleManager = require('./module-manager')(moduleStore, params.appRootPath, params.appContainer, resourceResolver);
    ...
    api.load();
    logger.info("API request processor for app: %s - loaded and ready", params.appContainer);
    ...
    function internalProcessHttpRequest(request, callback)
    {
        ...
        if (requestObject.Mode === "AppDefinition")
        {
            ...
            logger.debug("AppDefinition requested, returning: " + JSON.stringify(appDefinition, null, 4));
