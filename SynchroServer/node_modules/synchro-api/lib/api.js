...
SynchroApi.prototype.storeStateBeforeYield = function * (context)
{
...
SynchroApi.prototype.restoreStateAfterYield = function * (context)
{
...
SynchroApi.prototype.waitForAwaitable = function * (moduleObject, context, args) 
{
    ...
    yield this.storeStateBeforeYield(context);
    ...
    yield this.restoreStateAfterYield(context);
