...
function getViewModel(synchroApi, route, routeModule, context, session, params, state)
{
    viewModel = {};
    
    var instanceId = getCurrentModuleInstance(context);
    
    synchroApi.callHookFunction("BeforeInitializeViewModel", route, routeModule, context, session.UserData, params, state);
    ...
    if (instanceId == getCurrentModuleInstance(context))
    {
        ...
        synchroApi.callHookFunction("AfterInitializeViewModel", route, routeModule, context, session.UserData, params, state, viewModel);
    }

    return viewModel;
}

function getView(synchroApi, route, routeModule, context, session, viewModel, isViewMetricUpdate)
{
    ...
    synchroApi.callHookFunction("BeforeInitializeView", route, routeModule, context, session.UserData, viewModel, view, metrics, isViewMetricUpdate);
    ...
    synchroApi.callHookFunction("AfterInitializeView", route, routeModule, context, session.UserData, viewModel, view, metrics, isViewMetricUpdate);
...
{
    var instanceId = getCurrentModuleInstance(context);
    var viewModel = getViewModel(synchroApi, route, routeModule, context, context.session, params, state);
    ...
    var view = getView(synchroApi, route, routeModule, context, context.session, viewModel);
...
{
    return this.moduleManager.reloadModule(moduleName);
}
...
//
SynchroApi.prototype.callHookFunction = function(functionName)
{
    try
    {
        this.moduleManager.callHookFunction.apply(this.moduleManager, arguments);
    }
    catch (e)
    {
    ...
    {                
        ...
        if (context.request.ViewModelDeltas)
        {
            ...
            if (routeModule.OnViewModelChange || this.isFunctionHooked("OnViewModelChange"))
            {
                ...
                //                
                this.callHookFunction("BeforeOnViewModelChange", route, routeModule, context, context.session.UserData, context.LocalViewModel.ViewModel, "view", viewModelUpdates);
                ...
                this.callHookFunction("AfterOnViewModelChange", route, routeModule, context, context.session.UserData, context.LocalViewModel.ViewModel, "view", viewModelUpdates);
            }
        }
        else
        {
        ...
        switch (requestObject.Mode)
        {
            ...
            case "Resync":
            {
                ...
                if ((context.request.InstanceId >= 0) && (context.request.InstanceVersion >= 0))
                {
                    ...
                    if (!isCurrentModuleInstance(context, context.request.InstanceId))
                    {
                        ...
                        //
                        context.response.Path = route;
                        context.response.View = getView(this, route, routeModule, context, context.session, context.session.ModuleInstance.ClientViewModel.ViewModel);
                        context.response.Back = isBackAvailable(context, routeModule);
                    }
                }
            ...
            case "LoadPage":
            {
                ...
                this.callHookFunction("BeforeLoadViewModel", route, routeModule, context, context.session.UserData, context.LocalViewModel.ViewModel);
                if (routeModule.LoadViewModel)
                {
                    try 
                    {
                ...
                this.callHookFunction("AfterLoadViewModel", route, routeModule, context, context.session.UserData, context.LocalViewModel.ViewModel);
            }
            break;

            case "Back":
            {
                this.callHookFunction("BeforeOnBack", route, routeModule, context, context.session.UserData, context.LocalViewModel.ViewModel);
                ...
                this.callHookFunction("AfterOnBack", route, routeModule, context, context.session.UserData, context.LocalViewModel.ViewModel);
            }
            break;
            ...
            case "Command":
            {
                ...
                this.callHookFunction("BeforeCommand", route, routeModule, context.request.Command, context, context.session.UserData, context.LocalViewModel.ViewModel, context.request.Parameters);
                ...
                if (routeModule.Commands && routeModule.Commands[context.request.Command])
                {
                    ...
                    if (routeModule.OnViewModelChange || this.isFunctionHooked("OnViewModelChange"))
                    {
                        ...
                        // The hook will get called whether or not there were any changes (whereas the module function only gets called if there were changes)
                        //                
                        this.callHookFunction("BeforeOnViewModelChange", route, routeModule, context, context.session.UserData, context.LocalViewModel.ViewModel, "command", viewModelUpdates);
                        ...
                        this.callHookFunction("AfterOnViewModelChange", route, routeModule, context, context.session.UserData, context.LocalViewModel.ViewModel, "command", viewModelUpdates);
                    }
                }
                ...
                this.callHookFunction("AfterCommand", route, routeModule, context.request.Command, context, context.session.UserData, context.LocalViewModel.ViewModel, context.request.Parameters);
            }
            break;
            ...
            case "ViewUpdate":
            {
                ...
                if (routeModule.OnViewMetricsChange || this.isFunctionHooked("OnViewMetricsChange"))
                {
                    ...
                    this.callHookFunction("BeforeOnViewMetricsChange", route, routeModule, context, context.session.UserData, context.LocalViewModel.ViewModel, metrics);
                    ...
                    if (routeModule.OnViewModelChange || this.isFunctionHooked("OnViewModelChange"))
                    {
                        ...
                        // The hook will get called whether or not there were any changes (whereas the module function only gets called if there were changes)
                        //                
                        this.callHookFunction("BeforeOnViewModelChange", route, routeModule, context, context.session.UserData, context.LocalViewModel.ViewModel, "viewMetrics", viewModelUpdates);
                        ...
                        this.callHookFunction("AfterOnViewModelChange", route, routeModule, context, context.session.UserData, context.LocalViewModel.ViewModel, "viewMetrics", viewModelUpdates);
                    }

                    this.callHookFunction("AfterOnViewMetricsChange", route, routeModule, context, context.session.UserData, context.LocalViewModel.ViewModel, metrics);
                }
                ...
                if (isCurrentModuleInstance(context, context.LocalViewModel.instanceId))
                {
                    ...
                    if (context.session.ModuleInstance.dynamic)
                    {
                        ...
                        var view = getView(this, route, routeModule, context, context.session, context.LocalViewModel.ViewModel, true);
