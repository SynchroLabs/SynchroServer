    ...
    try
    {
        ...
        switch (requestObject.Mode)
        {
            ...
            case "Back":
            {
                ...
                {
                    yield this.callUserModuleFunctionAwaitable(routeModule, routeModule.OnBack, context, context.session.UserData, context.LocalViewModel.ViewModel); 
                }
                else
                {
                    // default "pop"
...
// Exposed via Synchro.waitForAwaitable()
//
// Await a standard Node async function (that takes a final paramter of a completion callback).
//
SynchroApi.prototype.waitForAwaitable = function * (moduleObject, context, args) 
{
    ...
    {
        var fn = args.shift(); // Pull the function arg
        args.push(done);       // Append the callback
        fn.apply(moduleObject, args);
    } 
