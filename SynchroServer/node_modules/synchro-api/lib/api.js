...
SynchroApi.prototype.process = function(session, requestObject, responseObject)
{
    ...
    {        
        ...
        if (versRequired && !semver.satisfies(context.session.DeviceMetrics.clientVersion, versRequired))
        {
        ...
        //
        if (this.appDefinition.synchro && this.appDefinition.synchro.clientVersion && !semver.satisfies(context.session.DeviceMetrics.clientVersion, this.appDefinition.synchro.clientVersion))
        {
