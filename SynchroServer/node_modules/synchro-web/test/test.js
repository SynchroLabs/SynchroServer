...
global.screen = { width: 640, height: 480 };
global.window = { document: {}, innerWidth: 100, innerHeight: 100 };
global.document = { documentElement: { clientWidth: 200, clientHeight: 200 } };
...
var calls;
exports.recordCall = function()
{
    calls++;
}
exports.assertDone = function(count)
{
    if (!count)
    {
        count = 1;
    }
    assert.equal(calls, count, "Test did not complete, incorrect number of calls recorded");
}
