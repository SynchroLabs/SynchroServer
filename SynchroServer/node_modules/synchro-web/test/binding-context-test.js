...
describe("BindingContext", function () 
{
    ...
    it("should select parent element", function ()
    {
        ...
        assert.equal(null, bindingCtx.select("colors[1].name").select("$parent.$parent.$parent.$parent").getValue());
    });
    ...
    it("should select parent element in array of array", function ()
    {
        ...
        assert.equal(1, bindingCtx.select("board[1][0]").select("$parent.$index").getValue().getValue());
    });
    ...
    it("should index element on array item", function ()
    {
        ...
        assert.equal(1, bindingCtx.select("colors[1]").select("$index").getValue().getValue());
    });
    ...
    it("should index element inside array item", function ()
    {
        ...
        assert.equal(1, bindingCtx.select("colors[1].name").select("$index").getValue().getValue());
    });
