...
App issues (web client)
  ...
  Back nav problem - when nav via Synchro "back", goes back page, but does not move back in history
  ...
  PropX / Civics - No location services availble when return to search page from list page
