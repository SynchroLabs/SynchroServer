...
ViewModel.prototype.setViewModelData = function(viewModel)
{
    ...
    {
        this._valueBinding[i].getBindingContext().setBindingRoot(this._rootBindingContext.getBindingRoot());
    }
    for (var i = 0; i < this._propertyBindings.length; i++)
    {
        ...
        {
            bindingContexts[j].setBindingRoot(this._rootBindingContext.getBindingRoot());
        }
    }
}
