...
// !!! This did not exist - the ports all have a bunch of type case overloads to produce values
//     of various types.  Investigate this later to see if we need that.
//
...
JToken.prototype.selectToken = function(path, errorWithNoMatch)
{
...
JToken.prototype.toJson = function()
{
    ...
    {
        if ((typeof this._value === 'boolean') || (typeof this._value === 'number') || (typeof this._value == 'null'))
        {
            json += this._value;
        }
