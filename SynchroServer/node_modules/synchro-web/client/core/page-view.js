...
{
    logger.info("Setting onPageTitleCallback:", callback);
...
PageView.prototype.goBack = function()
{
    ...
    else if ((this._doBackToMenu != null) && this._stateManager.isOnMainPath()) // !!! Should this be !isOnMainPath()?
    {
...
PageView.prototype.processPageView = function(pageView)
{
    ...
    var pageTitle = pageView["title"];
    if (pageTitle != null)
    {
        this._onPageTitleCallback(pageTitle);
    }
