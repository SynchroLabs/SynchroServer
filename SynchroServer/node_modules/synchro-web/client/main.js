...
var page = document;
var containerControl = document.getElementById('synchro');
var backToMenu = null;

var pageView = new WebPageView(stateManager, stateManager.getViewModel(), page, containerControl, backToMenu);

document.getElementById('back').addEventListener("click", function(){ pageView.goBack() }, false);
...
pageView.setOnBackEnabledCallback(function(isEnabled)
{
    ...
    document.getElementById('back').style.visibility = isEnabled ? "visible" : "hidden";
});
