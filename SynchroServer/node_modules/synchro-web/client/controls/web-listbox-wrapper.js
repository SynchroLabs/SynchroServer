...
var WebListBoxWrapper = function(parent, bindingContext, controlSpec)
{
    ...
    logger.debug("ListBox control created");
    ...
    if (bindingSpec["items"])
    {
        ...
        this.processElementBoundValue(
            "items",
            bindingSpec["items"],
            function() { return self.getListboxContents(listbox) },
    ...
    listbox.addEventListener("change", this.onSelectionChanged.bind(this), false);
}
...
WebListBoxWrapper.prototype.setListboxContents = function(listbox, bindingContext, itemContent)
{
    ...
    for (var i = 0; i < itemContexts.length; i++)
    {
        ...
        option.innerHTML = lodash.escape(PropertyValue.expandAsString(itemContent, itemContext));
