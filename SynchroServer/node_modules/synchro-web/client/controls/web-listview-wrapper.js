...
var WebListViewWrapper = function(parent, bindingContext, controlSpec)
{
    ...
    // !!! Header, footer elements, other stuff remaining to be ported?

    // !!! Child LI elements have click handlers, need to coordinate with parent (which moderates item selection consistent with list selection mode)
...
// !!! Not a listener - but needs to be called from our internal selection state manager when selection changes
//
