...
WebControlWrapper.prototype.setHeight = function(control, value)
{
    ...
    if (heightString.indexOf("*") >= 0)
    {
        ...
        control.style.height = "100%"; // If only control in non-Flexbox div (flexbox will override)
    }
    else
    {
...
WebControlWrapper.prototype.setWidth = function(control, value)
{
    ...
    if (widthString.indexOf("*") >= 0)
    {
        ...
        control.style.width = "100%"; // If only control in non-Flexbox div (flexbox will override)
    }
    else
    {
...
WebControlWrapper.prototype.processCommonFrameworkElementProperies = function(controlSpec)
{
    ...
    // !!! Test
    this.processElementProperty(controlSpec, "minheight", function(value) { self._control.style.minHeight = self.toDouble(value) + "px" }); // !!! ToDeviceUnits(value)
    this.processElementProperty(controlSpec, "minwidth", function(value) { self._control.style.minWidth = self.toDouble(value) + "px" }); // !!! ToDeviceUnits(value)
    this.processElementProperty(controlSpec, "maxheight", function(value) { self._control.style.maxHeight = self.toDouble(value) + "px" }); // !!! ToDeviceUnits(value)
    this.processElementProperty(controlSpec, "maxwidth", function(value) { self._control.style.maxWidth = self.toDouble(value) + "px" }); // !!! ToDeviceUnits(value)
