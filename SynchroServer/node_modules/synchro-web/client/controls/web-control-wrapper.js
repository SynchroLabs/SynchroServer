...
WebControlWrapper.prototype.processCommonFrameworkElementProperies = function(controlSpec)
{
    ...
    */
    // !!! Not sure what happens if the element is not an <input> element... hasAttribute("disabled")?
    this.processElementProperty(controlSpec, "enabled", function(value) { self._control.disabled = !self.toBoolean(value) });
    /*
