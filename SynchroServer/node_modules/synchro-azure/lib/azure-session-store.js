...
module.exports = function(params)
{
    ...
    var sessionStore = 
    {
        ...
        {
            return yield function(done){createSessionAzure(done)}
        },

        getSession: function * (sessionId) // Generator
        {
            return yield function(done){getSessionAzure(sessionId, done)}
        },

        putSession: function * (session) // Generator
        {
            return yield function(done){putSessionAzure(session, done)}
        },

        deleteSession: function * (sessionId) // Generator
        {
            return yield function(done){deleteSessionAzure(sessionId, done)}
        }
    }
